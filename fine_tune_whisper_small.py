...
visualization_callback = TrainingVisualizationCallback(output_dir="./small/whisper-lux-visuals")
...
#trainer.train(resume_from_checkpoint="./small/whisper-lux/checkpoint-5000")
trainer.train()
...
model.save_pretrained("./small/whisper-lux-final")
processor.save_pretrained("./small/whisper-lux-final")
# Save the generation configuration explicitly
model.generation_config.save_pretrained("./small/whisper-lux-final")
